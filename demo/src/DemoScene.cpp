...
//-----------------------------------------------------------------------------------------------------
void DemoScene::paused( const bool _isPaused )
{
  m_solver.setPaused(_isPaused);
}
//-----------------------------------------------------------------------------------------------------

...
private:
  ...
  std::array<matPtr, 3> m_materials = {{
    matPtr{new MaterialPhong(m_camera, m_shaderLib, &m_matrices)},
    matPtr{new MaterialPBR(m_camera, m_shaderLib, &m_matrices, {0.5f, 0.0f, 0.0f})},
    matPtr{new MaterialPBR(m_camera, m_shaderLib, &m_matrices, {0.0f, 0.5f, 0.5f})}
  }};
  //-----------------------------------------------------------------------------------------------------
